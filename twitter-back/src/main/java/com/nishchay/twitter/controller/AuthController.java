...
import com.nishchay.twitter.model.Varification;
import com.nishchay.twitter.repository.UserRepository;
import com.nishchay.twitter.response.AuthResponse;
import com.nishchay.twitter.service.CustomUserDetailsServiceImplementation;
...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws UserException{
		...
		String birtDate=user.getBirthDate();
